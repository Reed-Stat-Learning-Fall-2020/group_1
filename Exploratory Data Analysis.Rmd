...
ggplot(total_2015_filtered, aes( x=`Total Loss`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Total Loss`,log(total_2015_filtered$salary))


ggplot(total_2015_filtered, aes( x=Pitches,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$Pitches,log(total_2015_filtered$salary))
...
ggplot(total_2015_filtered, aes( x=Win_Percent,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$Win_Percent,log(total_2015_filtered$salary))
...
```{r}
ggplot(total_2015_filtered, aes( x=`ERA`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`ERA`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Total ER`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Total ER`,log(total_2015_filtered$salary))
```
...
```{r}
ggplot(total_2015_filtered, aes( x=`Total Strikes`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Total Strikes`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Total Balls`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Total Balls`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Total Hit`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Total Hit`,log(total_2015_filtered$salary))
```
...
```{r}
ggplot(total_2015_filtered, aes( x=`Strike Percent`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Strike Percent`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Ball Percent`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Ball Percent`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Hit Percent`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Hit Percent`,log(total_2015_filtered$salary))
```
...
```{r}
ggplot(total_2015_filtered, aes( x=`Average Pitch Speed`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Pitch Speed`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Average Effective Pitch Speed`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Effective Pitch Speed`,log(total_2015_filtered$salary))
...
```{r}
ggplot(total_2015_filtered, aes( x=`Average Spin Rate`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Spin Rate`,log(total_2015_filtered$salary))
```
...
```{r}
ggplot(total_2015_filtered, aes( x=`Average Horizontal Break`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Horizontal Break`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`Average Vertical Break`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Vertical Break`,log(total_2015_filtered$salary))
```
...
```{r}
ggplot(total_2015_filtered, aes( x=`BAA`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`BAA`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`SLGA`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`SLGA`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`BABIPA`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`BABIPA`,log(total_2015_filtered$salary))

ggplot(total_2015_filtered, aes( x=`wOBAA`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`wOBAA`,log(total_2015_filtered$salary))
...
ggplot(total_2015_filtered, aes( x=`Average Barrel`,y=log(salary))) +
  geom_point(alpha=0.5)+
  theme_classic()

cor(total_2015_filtered$`Average Barrel`,log(total_2015_filtered$salary))
```
...
```{r}
total_quant_pred <- select_if(total_2015_filtered, is.numeric)

total_quant_pred <- total_quant_pred %>% dplyr::select(-yearID,-mlb_id,-W,-L,-`Average Balls`)

predictor_correlations<-cor(total_quant_pred)
