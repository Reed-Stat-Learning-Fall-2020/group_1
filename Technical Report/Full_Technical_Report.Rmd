...
The following plot is just another way to look at ordered absolute residuals to more easily see the underperformers and overperformers relative to our modeling expectations. The points colored purple have a positive residual whereas the points in grey have a negative residual.
...
pitchers_2019_tidy %>%
  ...
  scale_color_manual(values = c("midnightblue","gray60")) +
