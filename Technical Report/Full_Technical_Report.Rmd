...
cor(teams$ERA,
   teams$W)
```
Figure 1: Total team wins plotted against team ERA; trend line represents linear line of best fit. Correlation between the two values shown underneath.
...
ggplot(Mega_Summary_Filtered, 
  ...
  theme_classic()
```
Figure 2: Histogram of MLB starting pitcher salary, the evident right skew necessitated a log transformation.
...
ggplot(Mega_Summary_Filtered, 
  ...
  theme_classic()
```
Figure 3: Histogram of log-transformed MLB starting pitcher salary, the previously mentioned right skew is no longer as extreme.
...
Write broad conclusions/synthesis here.
Nontrivial disparities between predictors informing future salary and predictors informing ERA forecasts. ERA forecasting model with relatively substantial predictive capabilities, extensive benefits in application.
